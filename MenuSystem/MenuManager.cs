...
public class MenuManager : MonoBehaviour
{
    ...
    public PurchaseMenu PurchaseMenuPrefab;
    public StatsMenu StatsMenuPrefab;
	public LoseMenu LoseMenuPrefab;
    ...
    private void Awake()
    {
		...
		if (!GameManager.playPressed) {
			...
			GameMenu.Show ();
			// Game Music being played from Game Manager when gameStarted becomes true.
		}
